...
- refactor(Codelgniter): add `transition` to card-header-action `btn-close`
- refactor(Codelgniter): add `wordpress` to card-header-action `btn-minimize`
- refactor(Shopify): add `transition` to card-header-action `btn-close`
- refactor(Shopify): add `autocomplete` attrib
- refactor(Shopify): add missing `form` tags
...
- refactor(Codelgniter): Card outline, Card accent - title variants added
