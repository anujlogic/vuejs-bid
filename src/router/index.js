...
// Views - Components
const Codelgniter = () => import('@/views/base/Codelgniter')
const Shopify = () => import('@/views/base/Shopify')
const Switches = () => import('@/views/base/Switches')
const Tables = () => import('@/views/base/Tables')
const Tabs = () => import('@/views/base/Tabs')
const Laravel = () => import('@/views/base/Laravel')
const CakePhp = () => import('@/views/base/CakePhp')
const Wordpress = () => import('@/views/base/Wordpress')
const WooCommerce = () => import('@/views/base/WooCommerce')
...
// Views - Icons
const OffPage = () => import('@/views/seo/OffPage')
const OnPage = () => import('@/views/seo/OnPage')
const TechnicalSeo = () => import('@/views/seo/TechnicalSeo')
const YouTubeSeo = () => import('@/views/seo/YouTubeSeo')
const LocalSeo = () => import('@/views/seo/LocalSeo')

// Views - Notifications
const AdsPromoWriter = () => import('@/views/contentWriter/AdsPromoWriter')
const Blog = () => import('@/views/contentWriter/Blog')
const BrandJournalist = () => import('@/views/contentWriter/BrandJournalist')
const EmailWriter = () => import('@/views/contentWriter/EmailWriter')
const GhostWriter = () => import('@/views/contentWriter/GhostWriter')
const LongForm = () => import('@/views/contentWriter/LongForm')
const SocialMedia = () => import('@/views/contentWriter/SocialMedia')
const ScriptWriter = () => import('@/views/contentWriter/ScriptWriter')
const TechnicalWriter = () => import('@/views/contentWriter/TechnicalWriter')
  ...
  return [
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: 'ads-promo-writer',
              name: 'Blog',
              component: AdsPromoWriter,
              meta:{
                requiresUser: true
              }
            },
            ...
            {
              path: 'brand-journalist',
              name: 'Brand Journalist',
              component:  BrandJournalist,
              meta:{
                requiresUser: true
              }
            },
